 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.languages.tracery.traceryLanguage.impl.initialValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class initialValueImpl extends MinimalEObjectImpl.Container implements initialValue
{
  ...
  {
    return TraceryLanguagePackage.Literals.INITIAL_VALUE;
  }
  ...
  public EList<InternalInstruction> getValue()
  {
    if (value == null)
    {
      value = new EObjectContainmentEList<InternalInstruction>(InternalInstruction.class, this, TraceryLanguagePackage.INITIAL_VALUE__VALUE);
    }
    return value;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TraceryLanguagePackage.INITIAL_VALUE__VALUE:
